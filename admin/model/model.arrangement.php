...
class modelArrangement extends DB{
  ...
  private $columns_name="arrangement_title,arrangement_description,accommodation_type,room_type,check_in,check_out,
                        price,transport_type,accommodation_img,destination_id,guide_id";
  ...
  public function setArrangementTitle($arrangement_title){
    $this->arrangement_title=$arrangement_title;
  }
  public function getArrangementTitle(){
  ...
  public function insertArrangement(){
    $columns_value="'$this->arrangement_title','$this->arrangement_description','$this->accommodation_type','$this->room_type','$this->check_in',
  ...
  public function deleteArrangement(){
        ...
        //$pk_value="'$this->arrangement_id'";
    // parent::callStoredProcedureDelete('_deleteArrangement',$pk_value);
  }

  //UPDATE
  public function updateArrangement(){
    $columns="arrangement_title='$this->arrangement_title',arrangement_description='$this->arrangement_description',
            accommodation_type='$this->accommodation_type',room_type='$this->room_type',check_in='$this->check_in',check_out='$this->check_out',
            price=$this->price,transport_type='$this->transport_type',accommodation_img='$this->accommodation_img',destination_id=$this->destination_id,
