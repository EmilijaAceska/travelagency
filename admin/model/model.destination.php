...
class modelDestination extends DB{
  ...
  public function deleteDestination(){
        ...
        //$pk_value="'$this->destination_id'";
        // parent::callStoredProcedureDelete('_deleteDestination',$pk_value);
  }

  //UPDATE
  public function updateDestination(){
    $columns="destination_desc='$this->destination_desc',destination_img='$this->destination_img',
